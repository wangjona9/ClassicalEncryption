/**
 * An implementation of the Caesar Cipher. Implements the command line for user input.
 *
...
public class CaesarCipher {
  ...
  public static void main(String[] args) {
    ...
    if (validateInput(instruction, input)) {
      processInput(instruction, input); // Call functions to validate and process user input
    }
  }
}
